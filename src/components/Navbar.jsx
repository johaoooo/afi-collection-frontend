          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <div className="relative" ref={userMenuRef}>
              <button 
                ...
                className="w-9 h-9 rounded-full border border-gray-300 dark:border-afi-dark-border flex items-center justify-center hover:border-afi-green hover:bg-afi-green/10 transition-colors text-afi-green dark:text-gray-200"
              >
