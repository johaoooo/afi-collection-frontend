...
import { 
  faBagShopping, faShoppingCart, faSearch, faTimes, 
  faShoePrints, faStar
...
function Afisac() {
  ...
  const getCategoryIcon = (category) => {
    switch(category) {
      case 'sac': return faBagShopping;
      case 'chaussure': return faShoePrints;
    ...
    <FontAwesomeIcon icon={getCategoryIcon(product.category)} className="text-6xl text-afi-green opacity-50" />
                ...
                <div className="p-5">
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex items-center gap-1 text-xs text-gray-400"><FontAwesomeIcon icon={faStar} className="text-afi-yellow" /> {product.popularity || 0}</div>
                  </div>
