  ...
  return (
    <>
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-white/80 text-sm max-w-md mx-auto">
                AFI Collection représente le Bénin dans les grandes foires nationales, régionales et mondiales
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full font-semibold text-sm transition-all ${
                selectedYear === year
                  ...
                  : 'bg-white dark:bg-afi-green text-gray-600 dark:text-white/80 hover:bg-afi-green/10 border border-gray-200'
              }`}
            >
              {year}
            </button>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-full bg-afi-${event.color}/10 flex items-center justify-center`}>
                    <FontAwesomeIcon icon={event.icon} className={`text-xl text-afi-${event.color}`} />
                  </div>
                  <div className="text-left">
                    ...
                    <div className="flex items-center gap-3 mt-1">
                      <span className="flex items-center gap-1 text-xs text-gray-500">
                        <FontAwesomeIcon icon={faCalendarAlt} className="text-afi-green text-xs" />
                        {event.date}
                      </span>
                      <span className="flex items-center gap-1 text-xs text-gray-500">
                        <FontAwesomeIcon icon={faMapMarkerAlt} className="text-afi-green text-xs" />
                        {event.location}
                      </span>
                    </div>
                  </div>
                ...
                <FontAwesomeIcon 
                  icon={expandedEvent === event.id ? faChevronUp : faChevronDown} 
                    ...
                    <div className="border-t border-gray-100 pt-4">
                      ...
                      {event.photos && event.photos.length > 0 && (
                        <div className="mb-4">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <h4 className="font-semibold text-gray-800 text-sm">Galerie photos</h4>
                          </div>
                          ...
                          {event.photos.length > 4 && (
                            <p className="text-xs text-gray-500 mt-2">+{event.photos.length - 4} photos</p>
                          )}
                        </div>
                      )}
                      ...
                      {event.video && (
                        <div className="mb-4">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <h4 className="font-semibold text-gray-800 text-sm">Vidéo de l'événement</h4>
                          </div>
                          <div 
                            onClick={() => openMedia(event.video, 'video', event.title)}
                            className="relative group cursor-pointer rounded-lg overflow-hidden aspect-video bg-gray-900"
                          >
                            <img 
                              src={event.videoThumbnail} 
                              alt={`Vidéo ${event.title}`}
                      ...
                      <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
                        ...
                        <div className="flex gap-2">
                          <button className="text-xs text-afi-green hover:text-afi-greenDark font-semibold transition-all">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-800">Distinctions majeures</h3>
              </div>
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800 text-sm">Prix Africain de l'Artisanat</p>
                    <p className="text-xs text-gray-500">Lomé, Togo - 2026</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800 text-sm">Ambassadrice GRAAD GLOBAL</p>
                    <p className="text-xs text-gray-500">Londres, Royaume-Uni - 2025</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800 text-sm">Médaille d'Or de l'Artisanat</p>
                    <p className="text-xs text-gray-500">Porto-Novo, Bénin - 2023</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-800">Pays représentés</h3>
              </div>
              <div className="flex flex-wrap gap-2 mb-4">
                {countries.map((country, index) => (
                  <div key={index} className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 rounded-full">
                    ...
                    <span className="text-xs text-afi-green">({country.events})</span>
                  </div>
                ))}
              </div>
              <div className="mt-3 pt-3 border-t border-gray-100 text-center">
                <p className="text-sm text-gray-600">
                  AFI Collection continue d'étendre son rayonnement à l'international
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-afi-green to-afi-greenDark rounded-xl p-6 text-center text-white">
          ...
          <a 
            href="/contact" 
            className="inline-flex items-center gap-2 bg-white text-afi-green px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-all transform hover:scale-105"
          >
      ...
      <AnimatePresence>
        {selectedMedia && (
          ...
          >
            <button
              onClick={closeMedia}
              className="absolute top-4 right-4 text-white hover:text-afi-green transition-colors z-10"
            >
            ...
            <div className="max-w-5xl max-h-[90vh] w-full" onClick={(e) => e.stopPropagation()}>
              {mediaType === 'image' ? (
                <img
                  ...
                  className="rounded-xl shadow-2xl max-h-[85vh] w-full object-contain"
                />
              ) : (
